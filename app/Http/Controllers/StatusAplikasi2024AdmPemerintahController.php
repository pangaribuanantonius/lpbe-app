...
class StatusAplikasi2024AdmPemerintahController extends Controller
{
    public function updatestatus(Request $request){
        ...
        $tahun = request('tahun');
        \App\Models\Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', $jenis_aplikasi)->Where('tahun', '2024')->update([
            'status' => 'Final',
        ]);
         return redirect('layanan/index?layanan=aplikasi&jenisaplikasi=administrasi_pemerintah&tahun=2024')->with('updatestatus', 'Berhasil Memperbarui Data!');
    }
