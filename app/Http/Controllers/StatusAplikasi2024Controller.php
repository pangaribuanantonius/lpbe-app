...
class StatusAplikasi2024Controller extends Controller
{
    public function updatestatus(Request $request){
        ...
        \App\Models\Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', $jenis_aplikasi)->Where('tahun', '2024')->update([
         ...
         return redirect('layanan/index?layanan=aplikasi&jenisaplikasi=layanan_publik&tahun=2024')->with('updatestatus', 'Berhasil Memperbarui Data!');
    }
