...
class Aplikasi2024Controller extends Controller
{
    ...
    public function create(){
        ...
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        return view('aplikasi.layanan_publik.2024.create', ['nama_instansi' => $nama_instansi]);
    }
    ...
    public function edit(Aplikasi $aplikasi){
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        return view('aplikasi.layanan_publik.2024.edit', ['aplikasi' => $aplikasi, 'nama_instansi' => $nama_instansi]);
    }
    ...
    /*public function cetakaplikasipdf_2024(){
        ...
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        $aplikasi = \App\Models\Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', 'Layanan Publik')->Where('tahun', '2024')->Where('status', 'Final')->get();
        $penandatanganan = \App\Models\Penandatanganan::Where('instansi_id', $instansi_id)->first();
 
        $pdf = PDF::loadview('aplikasi.layanan_publik.2024.cetakaplikasipdf_2024',[
            'aplikasi'=>$aplikasi,
    ...
    public function cetakaplikasipublikpdf_2024(){

        $tahun = request('tahun');
        $statuss = \App\Models\Aplikasi::first();
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        $aplikasi = \App\Models\Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', 'Layanan Publik')->Where('tahun', '2024')->Where('status', 'Final')->Where('verifikasi', 'Disetujui')->get();
        $hitung_aplikasi = \App\Models\Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', 'Layanan Publik')->Where('tahun', '2024')->Where('status', 'Final')->Where('verifikasi', 'Disetujui')->count();
        $penandatanganan = \App\Models\Penandatanganan::Where('instansi_id', $instansi_id)->first();


        $html = View::make('aplikasi.layanan_publik.2024.cetaklaporanpdf', ['aplikasi'=>$aplikasi, 'hitung_aplikasi' => $hitung_aplikasi, 'penandatanganan'=>$penandatanganan, 'nama_instansi'=>$nama_instansi])->render();
    ...
    public function laporanterkirimaplikasipublikexcel2024(){
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        ...
        /*return view('aplikasi.2024.laporanterkirimaplikasipublikexcel2024', ['aplikasi' => $aplikasi]);*/
        return Excel::download(new LaporanTerkirimAplikasi2024Export($aplikasi), 'laporan-aplikasi-pelayanan-publik-2024.xlsx');
        
    }

     

    public function laporanterkirimaplikasipemerintahexcel2024(){
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        $aplikasi = Aplikasi::Where('instansi_id', $instansi_id)->Where('jenis_aplikasi', 'Administrasi Pemerintah')->Where('tahun', '2024')->Where('status', 'Final')->get();
        /*return view('aplikasi.2024.laporanterkirimaplikasipublikexcel2024', ['aplikasi' => $aplikasi]);*/
        return Excel::download(new LaporanTerkirimAplikasi2024AdmPemerintahExport($aplikasi), 'laporan-aplikasi-adm-pemerintah-2024.xlsx');
    ...
    /*public function cetaklaporanopdbeluminputaplikasipdf_2024(){
        $tahun = request('tahun');
        $statuss = \App\Models\Aplikasi::first();
        $instansi_id = \App\Models\User::where('username', session('username'))->first()->instansi_id;
        $nama_instansi = Instansi::where('id', $instansi_id)->first()->nama_instansi;
        ...
        $pdf = PDF::loadview('aplikasi.2024.cetakaplikasipdf_2024',[
            'aplikasi'=>$aplikasi,
            'penandatanganan'=>$penandatanganan,
            'nama_instansi'=>$nama_instansi,
        ])->setPaper('f4', 'landscape');;
    ...
    public function exportexcel()
    {
        ...
        $html = View::make('aplikasi.layanan_publik.2024.cetaklaporanexcel', [
            'aplikasi' => $aplikasi,
