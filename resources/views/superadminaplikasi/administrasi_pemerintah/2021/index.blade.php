...
<div class="modal fade" id="view{{ $aps->id }}" tabindex="-1" arial-labelly="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		...
		<div class="modal fade" id="modalStatus1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form method="post" action="{{ route('superadminaplikasi.administrasi_pemerintah.2021.updatestatus') }}" enctype="multipart/form-data">
						@csrf
						@method('POST')
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
					...
					<table class="table table-hover datatable">
						...
						<tbody>
							...
							<div class="modal fade" id="verifikasi{{ $aps->id }}" tabindex="-1" aria-labelly="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<form method="post" action="{{ route('superadminaplikasi.administrasi_pemerintah.2021.verifadmin', ['aplikasi' => $aps->id]) }}" enctype="multipart/form-data">
											@csrf
											@method('PATCH')
                ...
                <!-- <a class="btn btn-outline-success" href="{{ route('superadminaplikasi.administrasi_pemerintah.2021.laporanterkirimaplikasipemerintahexcel2021', ['instansi_id' => $instansi_id]) }}" target="_blank">
