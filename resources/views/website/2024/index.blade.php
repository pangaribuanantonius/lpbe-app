...
<a class="btn btn-outline-success" href="{{ route('website.2024.create') }}"><i class="bi bi-plus-circle"></i> Tambah Data</a>
							...
							<tr>
			                    ...
			                    <td>
			                    	<div class="text-center">
			                            ...
			                            <a class="btn btn-outline-primary text-center mb-1" style="white-space: nowrap;" href="{{ route('website.2024.edit', $w->id) }}"><i class="bi bi-pencil"></i> Edit</a>
			                        </div>
			                    </td>
							</tr>
