		...
		<div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-sm btn-outline-danger" data-bs-dismiss="modal"><i class="bi bi-x-circle"></i> Batal</button>
						<form method="post" action="{{ route('call_center.2021.updatestatuscallcenter') }}" enctype="multipart/form-data">
							@csrf
							@method('POST')
							<button type="submit" class="btn btn-sm btn-outline-primary btn-icon-split">
								<i class="bi bi-cloud-upload"></i> <span class="text">Lanjutkan</span>
...
<div class="text-end">
	...
	<a class="btn btn-success mb-2" href="{{ route('call_center.2021.cetaklaporanexcel') }}" target="_blank"><i class="bi bi-file-earmark-spreadsheet"></i> Excel</a>
</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
             ...
             <!-- <a class="btn btn-sm btn-outline-success" href="{{ route('call_center.2021.laporanterkirimcallcenterexcel2021') }}" target="_blank"><i class="bi bi-file-earmark-spreadsheet"></i> Excel</a> -->
