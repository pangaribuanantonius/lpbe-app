...
<!-- Modal ubah status -->
		<div class="modal fade" id="modalStatus1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form method="post" action="{{ route('superadmincall_center.2024.updatestatus') }}" enctype="multipart/form-data">
						@csrf
						@method('POST')
					...
					<table class="table table-hover datatable">
						...
						<tbody>
							...
							<div class="modal fade" id="verifikasi{{ $c->id }}" tabindex="-1" aria-labelly="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<form method="post" action="{{ route('superadmincall_center.2024.verifadmin', ['call_center' => $c->id]) }}" enctype="multipart/form-data">
											@csrf
											@method('PATCH')
