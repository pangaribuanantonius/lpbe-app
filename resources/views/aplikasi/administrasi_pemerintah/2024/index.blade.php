...
<a class="btn btn-outline-success" href="{{ route('aplikasi.administrasi_pemerintah.2024.create') }}"><i class="bi bi-plus-circle"></i> Tambah Data</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<form method="post" action="{{ route('aplikasi.administrasi_pemerintah.2024.finalisasinihil') }}" enctype="multipart/form-data">
					@csrf
					@method('POST')
					...
					<input type="hidden" name="urusan_id" value="Kosong">
					<input type="hidden" name="bidang_urusan_id" value="Kosong">
							...
							<tr>
			                    ...
			                    <td>
			                    	<div class="text-center">
			                            ...
			                            <a class="btn btn-outline-primary text-center mb-1" style="white-space: nowrap;" href="{{ route('aplikasi.administrasi_pemerintah.2024.edit', $aps->id) }}"><i class="bi bi-pencil"></i> Edit</a>
			                        </div>
			                    </td>
							</tr>
		...
		<div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-sm btn-outline-danger" data-bs-dismiss="modal"><i class="bi bi-x-circle"></i> Batal</button>
						<form method="post" action="{{ route('aplikasi.administrasi_pemerintah.2024.updatestatus') }}" enctype="multipart/form-data">
							@csrf
							@method('POST')
							<button type="submit" class="btn btn-sm btn-outline-primary btn-icon-split">
								<i class="bi bi-cloud-upload"></i> <span class="text">Lanjutkan</span>
...
<!--<div class="mb-2" align="right">
	...
	<ul class="dropdown-menu">
		<li><a class="dropdown-item" href="{{ route('aplikasi.administrasi_pemerintah.2024.cetaklaporanpdf') }}" target="_blank"><i class="bi bi-file-earmark-pdf"></i> PDF</a></li>
...
@else
<div class="text-end">
	<a class="btn btn-danger mb-2" href="{{ route('aplikasi.administrasi_pemerintah.2024.cetaklaporanpdf') }}" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i> PDF</a>
	<a class="btn btn-success mb-2" href="{{ route('aplikasi.administrasi_pemerintah.2024.cetaklaporanexcel') }}" target="_blank"><i class="bi bi-file-earmark-spreadsheet"></i> Excel</a>
</div>
<!-- @if($aplikasiadm->count() == $aplikasiadm->where('verifikasi', 'Disetujui')->count())
<div class="text-end">
	<a class="btn btn-danger mb-2" href="{{ route('aplikasi.administrasi_pemerintah.2024.cetaklaporanpdf') }}" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i> Cetak</a>
</div>
@else
