...
<section class="section dashboard">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<form method="post" action="{{ route('aplikasi.administrasi_pemerintah.2024.edit', ['aplikasi' => $aplikasi]) }}" enctype="multipart/form-data">
					@csrf
                    @method('PATCH')
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<form method="post" action="{{ route('aplikasi.layanan_publik.2024.delete', $aplikasi->id) }}" enctype="multipart/form-data">
										@csrf
										@method('DELETE')
										<input type="hidden" name="id">
