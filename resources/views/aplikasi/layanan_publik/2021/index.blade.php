							...
							<tr>
			                    ...
			                    <td>
			                    	<div class="text-center">
			                            ...
			                            <a class="btn btn-outline-primary text-center mb-1" style="white-space: nowrap;" href="{{ route('aplikasi.layanan_publik.2021.edit', $aps->id) }}"><i class="bi bi-pencil"></i> Edit</a>
			                        </div>
			                    </td>
							</tr>
...
<!--<div class="mb-2" align="right">
	...
	<ul class="dropdown-menu">
		<li><a class="dropdown-item" href="{{ route('aplikasi.layanan_publik.2021.cetaklaporanpdf') }}" target="_blank"><i class="bi bi-file-earmark-pdf"></i> PDF</a></li>
...
<section class="section dashboard">
	<div class="row">
		<div class="col-lg-12">
            ...
            <!-- <a class="btn btn-sm btn-outline-success" href="{{ route('aplikasi.layanan_publik.2021.laporanterkirimaplikasipublikexcel2021') }}" target="_blank"><i class="bi bi-file-earmark-spreadsheet"></i> Excel</a> -->
           <!--  <a class="btn btn-sm btn-outline-danger" href="{{ route('aplikasi.layanan_publik.2021.cetaklaporanpdf') }}" target="_blank"><i class="bi bi-file-earmark-pdf"></i> PDF</a> -->
