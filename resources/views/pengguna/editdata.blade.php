            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="post" action="{{ route('pengguna.edit', ['user' => $user]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PATCH')
                  <input type="hidden" name="id" value="{{ $user->id }}">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nip" type="text" class="form-control" id="nip" value="{{ $user->nip }}" required>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="post" action="{{ route('pengguna.editpassword', ['user' => $user]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PATCH')
                  <input type="hidden" name="id">
                    ...
                    <div class="row mb-3">
                      <label for="new_password" class="col-md-4 col-lg-3 col-form-label">Masukkan Password Baru</label>
                      <div class="col-md-8 col-lg-9">
